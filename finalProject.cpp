...
/*
* Psuedocode attempt for this program
Main (){
Define Variables 
Get string input of the customer
Menu to choose for manga

One Piece Vol 1 - 103
Attack on Titan 1 - 34
Jujustsu Kaisen 1 - 21
Bleach 1 - 74
Blue Lock 1 - 22

Gather data from customer
Ask if you want anymore manga
Display total for manga 
Sales Tax
...
/*
		...
		// Takes the title and volume of manga chosen
		if ((mangaChoice == 1) && (mangaVol >= 1 && mangaVol <= 103)){
				string mangaTitle = "One Piece";
				mangaPrice = 9.99;
				isValid = true;
				cout << "You have selected volume " << mangaVol << " of " << mangaTitle << endl;
		...
		// Takes the title and volume of manga chosen
		else if ((mangaChoice == 2) && (mangaVol >= 1 && mangaVol <= 34)){
				string mangaTitle = "Attack on Titan";
				mangaPrice = 10.99;
				isValid = true;
				cout << "You have selected volume " << mangaVol << " of " << mangaTitle << endl;
		...
		// Takes the title and volume of manga chosen
		else if ((mangaChoice == 3) && (mangaVol >= 0 && mangaVol <= 24)){
				string mangaTitle = "Jujutsu Kaisen";
				mangaPrice = 9.99;
				isValid = true;
				cout << "You have selected volume " << mangaVol << " of " << mangaTitle << endl;
		...
		// Takes the title and volume of manga chosen
		else if ((mangaChoice == 4) && (mangaVol >= 1 && mangaVol <= 74)){
				string mangaTitle = "Bleach";
				mangaPrice = 9.99;
				isValid = true;
				cout << "You have selected volume " << mangaVol << " of " << mangaTitle << endl;
		...
		// Takes the title and volume of manga chosen
		else if ((mangaChoice == 5) && (mangaVol >= 1 && mangaVol <= 26)){
				string mangaTitle = "Blue Lock";
				mangaPrice = 12.99;
				isValid = true;
				cout << "You have selected volume " << mangaVol << " of " << mangaTitle << endl;
		...
		// if input is invalid then will display message
		else {
			isValid = false;
			cout << "You have put an invalid input. Have a nice day" << endl;
			continue;
		}
